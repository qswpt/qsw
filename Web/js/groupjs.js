        ...
        if (data.Data.length > 0) {
            for (var i = 0; i < data.Data.length; i++) {
                html += '<div style="width:100%; position:absolute; top:' + topNum + 'rem; height:6.2rem; background-color:#fff border-radius: 0.5rem;" onclick="openInfo(' + data.Data[i].CommodityId + ')">' +
                    ...
                    ' font-size:0.7rem; color:#999999;">' + data.Data[i].CommodityGeneral + '</span><span style="position:inherit; left:0.25rem; top:2.67rem; font-size:0.7rem; color:#999999;">生产商: ' + data.Data[i].BrandName + '</span>' +
